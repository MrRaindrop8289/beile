            ...
            <div class="body">
	            <div class="table-responsive">
						...
						<table class="table table-hover dashboard-task-infos">
							...
							<form action="${pageContext.request.contextPath }/UpdateUuser" method="post">
								<tr>
									<td><input type="text" name="Id" value="${User1.id }" readonly="true"/></td>
									<td><input type="text" name="UserName1" value="${User1.username }" /></td>
									<td>
										<input type="text" name="yonghu_jb" value="${yonghu_jb }" list="LevelList"/>
									...
									<td><button type="sumbit" name="UpdateUser1" value="111" class="btn btn-primary">提交修改</button></td>
								</tr>
							</form>
						</table>
				</div>
