						...
						<form action="${pageContext.request.contextPath }/UpdateUuser" method="post">
							<c:forEach items="${ul }" var="u">
								<tr>
									<td>${u.username }</td>
									<td>${u.yonghu_jb }</td>
									<td><button type="sumbit" name="update" value="${u.username }" class="btn btn-primary">修改</button></td>
									<td><button type="sumbit" name="delete" value="${u.username }" class="btn btn-primary">删除</button></td>
								</tr>
							</c:forEach>
						</form>
					</table>
