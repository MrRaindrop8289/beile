...
<!-- 顶部状态栏 开始 -->
	...
	<h3>
		<ul class="nav nav-pills">
			<li role="presentation" class="active"><a href="Main.jsp">返回首页</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath }/FindAllStudent">客户信息</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath }/FindAllContract">合同信息</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath }/FindAllManage">试听课信息</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath }/BackUpDatabase">备份数据</a></li>
		</ul>
	</h3>
-->
                    <li>
						...
						<form action="${pageContext.request.contextPath }/UpdateContract" method="post">
							<c:forEach items="${ContractList }" var="c">
								<tr>
									...
									<c:if test="${c.isprincipal == true}">
										<td> 是</td>
									</c:if>
									<c:if test="${c.isprincipal == false}">
										<td> 否</td>
									</c:if>
									<c:if test="${User.yonghu_jb < 3 }">
										<td> <button type="sumbit" name="delete" value="${c.id }" class="btn btn-primary">删除</button></td>
										<td> <button type="sumbit" name="update" value="${c.id }" class="btn btn-primary">修改</button></td>
									</c:if>
								</tr>
							</c:forEach>
						</form>
