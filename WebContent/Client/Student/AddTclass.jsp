		...
		<div class="body">
		     <div class="table-responsive">
				...
				<table class="table table-hover dashboard-task-infos">
					...
					<form action="${pageContext.request.contextPath }/AddTclass" method="post">
						<tr>
							...
							<td><textarea rows="15" cols="90"  name="result"
							...
							<td><button type="submit" name="addTclass" value="123" class="btn btn-primary">提交</button></td>
						</tr>
